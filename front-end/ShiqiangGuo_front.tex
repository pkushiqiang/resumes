...
\begin{innerlist}        
        \item 6 years experience in Rich Internet Application development. 
        \item Expert in building complex Single-page application.
        \item Development with J2EE technologies like Spring, Struts, Hibernate, Maven, Tomcat.
...
\noindent\rule{\textwidth}{\hlinewidth}
\begin{innerlist}
\item JavaScript, HTML, jQuery, AngularJs, Bootstrap  Junit, OpenNLP, Python, Open Laszlo
\item Java, J2EE, Spring, Hibernate, Struts, Lucene, C/C++, PHP, Flask
...
\begin{innerlist}
	\item Led China team to develop RIA projects for Laszlo Systems and customers. 
    \item Optimized the compiler and Javascript runtime library of the OpenLaszlo platform.
